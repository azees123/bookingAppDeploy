          ...
          <Route path="/">
            ...
            <Route index element={<ProtectedRoute> <Home /> </ProtectedRoute>} />
              <Route path="users">
                ...
                <Route path=":userId" element={<ProtectedRoute><Single view='User' inputs={userInputs} /></ProtectedRoute>} />
              ...
              <Route path="hotels">
                ...
                <Route path=":hotelId" element={<ProtectedRoute><Single view='Hotel' inputs={hotelInputs} /></ProtectedRoute>} />
                <Route path="new" element={<ProtectedRoute><NewHotel/></ProtectedRoute>} />
              </Route>
              <Route path="rooms">
                <Route index element={<List columns={roomColumns}/>} />
                <Route path=":roomId" element={<ProtectedRoute><Single view='Room' inputs={roomInputs} /></ProtectedRoute>} />
